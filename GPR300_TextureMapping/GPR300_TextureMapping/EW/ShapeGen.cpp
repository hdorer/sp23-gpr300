...
namespace ew {
	...
	void createCube(float width, float height, float depth, MeshData& meshData)
	{
		...
		Vertex vertices[24] = {
			...
			//Bottom face
			{glm::vec3(-halfWidth, -halfHeight, -halfDepth), glm::vec3(0,-1,0), glm::vec2(0, 0)}, //BL
			{glm::vec3(+halfWidth, -halfHeight, -halfDepth), glm::vec3(0,-1,0), glm::vec2(0, 1)}, //BR
			{glm::vec3(+halfWidth, -halfHeight, +halfDepth), glm::vec3(0,-1,0), glm::vec2(1, 1)}, //TR
			{glm::vec3(-halfWidth, -halfHeight, +halfDepth), glm::vec3(0,-1,0), glm::vec2(0, 1)}, //TL
		};
	...
	void createSphere(float radius, int numSegments, MeshData& meshData)
	{
		...
		meshData.vertices.push_back({ glm::vec3(0,topY,0), glm::vec3(0,1,0), glm::vec2(0.5, 1)});
		...
		meshData.vertices.push_back({ glm::vec3(0,bottomY,0), glm::vec3(0,-1,0), glm::vec2(0.5, 0)});
	...
	void createCylinder(float height, float radius, int numSegments, MeshData& meshData)
	{
		...
		//VERTICES
		//Top cap (facing up)
		meshData.vertices.push_back(Vertex(glm::vec3(0, halfHeight, 0), glm::vec3(0, 1, 0), glm::vec2(0.5, 1)));
		for (int i = 0; i <= numSegments; i++)
		{
		...
		meshData.vertices.push_back(Vertex(glm::vec3(0, -halfHeight, 0), glm::vec3(0, -1, 0), glm::vec2(0.5, 0)));
